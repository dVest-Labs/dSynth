...
function Loan() {
    ...
    async function getUserLoans()
    {
        ...
        const collfactory_contract = isAddress(COLLATERAL_MINT_ADDRESS) && !!COLLATERAL_FACTORY_ABI && !!library_infura ? new Contract(COLLATERAL_MINT_ADDRESS, COLLATERAL_FACTORY_ABI, library_infura) : undefined;

        // get all descriptions for the events
        let filter = collfactory_contract.filters.NewEtherCollateralContract();
        ...
        for (k = 0; k < contract_array.length; k++) {
            ...
            const temp_coll_contract = isAddress(temp_contract_address) && !!COLLATERAL_ABI && !!library_infura ? new Contract(temp_contract_address, COLLATERAL_ABI, library_infura) : undefined;
            ...
            const temp_conj_contract = isAddress(temp_conj_addres) && !!ABI && !!library_infura ? new Contract(temp_conj_addres, ABI, library_infura) : undefined;
    ...
    async function checkConjureDetails() {
        ...
        try {
            ...
            const balance = await library_infura.getBalance(collateral);
            ...
            const userb = await library_infura.getBalance(account);
    ...
    function copylink ()
    {
        ...
        const minty_uri = "https://conjure.finance/loan";
            ...
            <div className="py-16 min-w-full flex flex-col justify-start items-center">
                                    ...
                                    <div className="py-4 w-full" key={`${field}-${idx}`}>
                                        <div className="md:flex flex-row w-full justify-center rounded-2xl w-full min-w-0 bg-indigo-400">
                                            ...
                                            <div
                                                ...
                                                <p className="text-center text-lg font-bold text-white">
                                                    {formatEther(field.collateralAmount)} ETH
                                                </p>
                                            </div>
                                            <div
                                                className="py-4 pl-2 sm:pr-10 pr-2  ">
                ...
                <div className="py-4 w-full">
                    ...
                    <div className="md:flex flex-row w-full justify-center">
                        <div className="py-4 pr-2 pl-2  rounded-2xl w-full md:w-6/12">
                            <p className="text-center text-lg font-bold text-white pb-4">
                    ...
                    <div className="py-1 w-full flex justify-center text-center">
                        <div className="py-1 w-full">
                            <button className="py-3 pr-2 pl-2 rounded-3xl md:w-3/12 w-6/12 hover:bg-btn-selected cursor-pointer border-4 border-btn-selected filter drop-shadow-2xl focus:outline-none"
                                ...
                                <p className="capitalize text-center text-2xl font-bold text-white">Submit Address</p>
                            </button>
                        </div>
                    </div>
                </div>
                ...
                {(ischecked ?
                        ...
                        <div className="py-1 w-full">
                            ...
                            <div className="py-1 w-full text-center">
                                <Link href={"/manage" + "?address=" + conjureAddress}>
                                    <button className="py-3 pr-2 pl-2 rounded-3xl md:w-3/12 w-6/12 bg-indigo-500 hover:bg-purple-300 cursor-pointer bg-gradient-to-r from-pink-500 to-purple-500"
                                            type="button">
                                        <p className="capitalize text-center text-sm  font-bold text-white">Asset Overview</p>
                                    </button>
                                </Link>
